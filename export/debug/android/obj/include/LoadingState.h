...
class HXCPP_CLASS_ATTRIBUTES LoadingState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static bool isSoundLoaded(::String path);
		static ::Dynamic isSoundLoaded_dyn();

		static bool isLibraryLoaded(::String library);
		static ::Dynamic isLibraryLoaded_dyn();
