...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String getPreloadPathlua(::String file);
		static ::Dynamic getPreloadPathlua_dyn();
		...
		static  ::flixel::graphics::frames::FlxAtlasFrames getSparrowAtlaslua(::String key,::String library);
		static ::Dynamic getSparrowAtlaslua_dyn();
