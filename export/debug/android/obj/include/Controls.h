...
class HXCPP_CLASS_ATTRIBUTES Controls_obj : public  ::flixel::input::actions::FlxActionSet_obj
{
	...
	public:
		...
		::Array< ::Dynamic> trackedinputsUI;
		::Array< ::Dynamic> trackedinputsNOTES;
		void addbuttonuNOTES( ::flixel::input::actions::FlxActionDigital action, ::flixel::ui::FlxButton button,int state);
		::Dynamic addbuttonuNOTES_dyn();

		void setHitBoxNOTES( ::ui::Hitbox hitbox);
		::Dynamic setHitBoxNOTES_dyn();

		void setVirtualPadNOTES( ::ui::FlxVirtualPad virtualPad, ::ui::FlxDPadMode DPad, ::ui::FlxActionMode Action);
		::Dynamic setVirtualPadNOTES_dyn();

		void addbuttonuUI( ::flixel::input::actions::FlxActionDigital action, ::flixel::ui::FlxButton button,int state);
		::Dynamic addbuttonuUI_dyn();

		void setHitBoxUI( ::ui::Hitbox hitbox);
		::Dynamic setHitBoxUI_dyn();

		void setVirtualPadUI( ::ui::FlxVirtualPad virtualPad, ::ui::FlxDPadMode DPad, ::ui::FlxActionMode Action);
		::Dynamic setVirtualPadUI_dyn();

		void removeFlxInput(::Array< ::Dynamic> Tinputs);
