...
HXLINE(  94)				::flixel::FlxG_obj::log->advanced(((HX_("Could not find a Sound asset with an ID of '",6f,0e,1e,66) + EmbeddedSound) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            			}
            		}
            	}
...
HXDLIN( 102)		::String prefix = HX_("",00,00,00,00);
HXDLIN( 102)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(site))) {
HXDLIN( 102)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXDLIN( 102)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + site)),HX_("_blank",95,26,d9,b0));
            	}
...
HXDLIN(  20)		difficultyStuff = ::cpp::VirtualArray_obj::__new(2)->init(0,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("Hard",0b,5b,e1,2f))->init(1,HX_("",00,00,00,00)))->init(1,::cpp::VirtualArray_obj::__new(2)->init(0,HX_("Spicy",c2,0e,9a,14))->init(1,HX_("-spicy",95,db,7b,7f)));
            	}
}
