...
HXLINE(  79)		{
HXLINE(  79)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  79)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v2);
            		}
HXLINE(  82)		library = ::lime::utils::Assets_obj::getLibrary(HX_("videos",98,d7,95,e5));
HXLINE(  83)		if (::hx::IsNotNull( library )) {
HXLINE(  83)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  84)			::ManifestResources_obj::preloadLibraryNames->push(HX_("videos",98,d7,95,e5));
            		}
HXLINE(  85)		library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
