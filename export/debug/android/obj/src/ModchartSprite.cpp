...
HX_DEFINE_STACK_FRAME(_hx_pos_2b7f7cc83b4d0792_1371_new,"ModchartSprite","new",0xbc67fd93,"ModchartSprite.new","FunkinLua.hx",1371,0x00117937)

void ModchartSprite_obj::__construct( ::Dynamic X, ::Dynamic Y, ::Dynamic SimpleGraphic){
            	HX_STACKFRAME(&_hx_pos_2b7f7cc83b4d0792_1371_new)
HXLINE(1373)		this->wasAdded = false;
HXLINE(1371)		super::__construct(X,Y,SimpleGraphic);
            	}
