...
void MemoryCounter_obj::__construct(::hx::Null< Float >  __o_inX,::hx::Null< Float >  __o_inY,::hx::Null< int >  __o_inCol){
            		...
            		Float inY = __o_inY.Default(((Float)50.0));
...
HXLINE(  37)		if (::ClientPrefs_obj::showFPS) {
HXLINE(  39)			this->set_text(((((HX_("\nRAM: ",9a,ab,9e,61) + mem) + HX_(" MB\nRAM maxima: ",d6,f7,9e,70)) + this->memPeak) + HX_(" MB",75,8b,18,00)));
            		}
            	}
