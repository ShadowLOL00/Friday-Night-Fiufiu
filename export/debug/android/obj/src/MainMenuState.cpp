...
static const ::String _hx_array_data_205e8859_1[] = {
	HX_("story_mode",2d,63,e6,a4),HX_("freeplay",a0,90,86,22),HX_("awards",b6,92,c1,8d),HX_("credits",1a,0e,5e,13),HX_("discord",ac,b9,b4,b2),HX_("options",5e,33,fe,df),
};
...
HXLINE(  62)		bg1->scrollFactor->set(0,0);
HXLINE(  63)		bg1->updateHitbox();
HXLINE(  64)		bg1->screenCenter(null());
HXLINE(  65)		bg1->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
...
HXLINE(  70)		this->add(this->camFollow);
HXLINE(  71)		this->add(this->camFollowPos);
HXLINE(  73)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  73)		::String library1 = null();
HXDLIN(  73)		this->magenta = _hx_tmp2->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE(  74)		this->magenta->scrollFactor->set(0,0);
HXLINE(  75)		this->magenta->updateHitbox();
HXLINE(  76)		this->magenta->screenCenter(null());
HXLINE(  77)		this->magenta->set_visible(false);
HXLINE(  78)		this->magenta->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  79)		this->magenta->set_color(-167525);
HXLINE(  80)		this->add(this->magenta);
HXLINE(  83)		this->menuItems =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  84)		this->add(this->menuItems);
HXLINE(  86)		{
HXLINE(  86)			int _g = 0;
HXDLIN(  86)			int _g1 = this->optionShit->length;
HXDLIN(  86)			while((_g < _g1)){
HXLINE(  86)				_g = (_g + 1);
HXDLIN(  86)				int i = (_g - 1);
HXLINE(  88)				Float offset = (( (Float)(108) ) - ((::Math_obj::max(( (Float)(this->optionShit->length) ),( (Float)(4) )) - ( (Float)(4) )) * ( (Float)(80) )));
HXLINE(  89)				 ::flixel::FlxSprite menuItem =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,((i * 140) + offset),null());
HXLINE(  90)				::String key = (HX_("mainmenu/menu_",a9,7b,4b,27) + this->optionShit->__get(i));
HXDLIN(  90)				::String library = null();
HXDLIN(  90)				 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  90)				menuItem->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE(  91)				menuItem->animation->addByPrefix(HX_("idle",14,a7,b3,45),(this->optionShit->__get(i) + HX_(" basic",8e,b6,25,79)),24,null(),null(),null());
HXLINE(  92)				menuItem->animation->addByPrefix(HX_("selected",5b,2a,6d,b1),(this->optionShit->__get(i) + HX_(" white",89,d6,28,95)),24,null(),null(),null());
HXLINE(  93)				menuItem->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE(  94)				menuItem->ID = i;
HXLINE(  95)				menuItem->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  96)				this->menuItems->add(menuItem).StaticCast<  ::flixel::FlxSprite >();
HXLINE(  97)				Float scr = (( (Float)((this->optionShit->length - 4)) ) * ((Float)0.135));
HXLINE(  98)				if ((this->optionShit->length < 6)) {
HXLINE(  98)					scr = ( (Float)(0) );
            				}
HXLINE(  99)				menuItem->scrollFactor->set(0,scr);
HXLINE( 100)				menuItem->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 101)				menuItem->setGraphicSize(::Std_obj::_hx_int((menuItem->get_width() * ((Float)0.75))),null());
HXLINE( 102)				menuItem->updateHitbox();
            			}
            		}
HXLINE( 105)		::flixel::FlxG_obj::camera->follow(this->camFollowPos,null(),1);
HXLINE( 107)		 ::flixel::text::FlxText versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,(::flixel::FlxG_obj::height - 44),0,(HX_("Psych Engine v",5d,a0,37,c7) + ::MainMenuState_obj::psychEngineVersion),12,null());
HXLINE( 108)		versionShit->scrollFactor->set(null(),null());
HXLINE( 109)		versionShit->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 110)		this->add(versionShit);
HXLINE( 111)		int versionShit1 = (::flixel::FlxG_obj::height - 24);
HXDLIN( 111)		 ::flixel::text::FlxText versionShit2 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,versionShit1,0,(HX_("Friday Night Fiufiu v",1f,85,38,88) + ::lime::app::Application_obj::current->meta->get(HX_("version",18,e7,f1,7c))),12,null());
HXLINE( 112)		versionShit2->scrollFactor->set(null(),null());
HXLINE( 113)		versionShit2->setFormat(HX_("VCR OSD Mono",be,44,e4,b8),16,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 114)		this->add(versionShit2);
HXLINE( 118)		this->changeItem(null());
HXLINE( 121)		::Achievements_obj::loadAchievements();
HXLINE( 122)		 ::Date leDate = ::Date_obj::now();
HXLINE( 123)		bool _hx_tmp3;
HXDLIN( 123)		if ((leDate->getDay() == 5)) {
HXLINE( 123)			_hx_tmp3 = (leDate->getHours() >= 18);
            		}
            		else {
HXLINE( 123)			_hx_tmp3 = false;
            		}
HXDLIN( 123)		if (_hx_tmp3) {
HXLINE( 124)			int achieveID = ::Achievements_obj::getAchievementIndex(HX_("friday_night_play",9b,1f,4e,c7));
HXLINE( 125)			if (!(::Achievements_obj::isAchievementUnlocked(( (::String)(::Achievements_obj::achievementsStuff->__get(achieveID)->__GetItem(2)) )))) {
HXLINE( 126)				::Achievements_obj::achievementsMap->set(( (::String)(::Achievements_obj::achievementsStuff->__get(achieveID)->__GetItem(2)) ),true);
HXLINE( 127)				this->giveAchievement();
HXLINE( 128)				::ClientPrefs_obj::saveSettings();
            			}
            		}
HXLINE( 134)		this->addVirtualPad(::ui::FlxDPadMode_obj::UP_DOWN_dyn(),::ui::FlxActionMode_obj::A_B_dyn());
...
HXLINE( 144)		this->add( ::AchievementObject_obj::__alloc( HX_CTX ,HX_("friday_night_play",9b,1f,4e,c7),this->camAchievement));
...
HXLINE( 146)		::haxe::Log_obj::trace(HX_("Giving achievement \"friday_night_play\"",e6,1b,7d,1f),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),146,HX_("MainMenuState",59,88,5e,20),HX_("giveAchievement",1e,ea,83,24)));
            	}
...
HXDLIN( 153)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 154)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 156)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 156)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
...
HXLINE( 185)				if ((this->optionShit->__get(::MainMenuState_obj::curSelected) == HX_("discord",ac,b9,b4,b2))) {
HXLINE( 187)					::CoolUtil_obj::browserLoad(HX_("https://discord.gg/uVdSYYgXYM",53,f3,e3,1e));
            				}
            				else {
...
HXLINE( 260)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 261)			spr->offset->set_y(( (Float)(0) ));
HXLINE( 262)			spr->updateHitbox();
HXLINE( 264)			if ((spr->ID == ::MainMenuState_obj::curSelected)) {
HXLINE( 266)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 267)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 267)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 267)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
HXLINE( 268)				spr->offset->set_x((((Float)0.21) * ((( (Float)(spr->frameWidth) ) / ( (Float)(2) )) + 180)));
HXLINE( 269)				spr->offset->set_y((((Float)0.15) * ( (Float)(spr->frameHeight) )));
HXLINE( 270)				::flixel::FlxG_obj::log->advanced(spr->frameWidth,::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 250)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 251)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::MainMenuState >();
HXDLIN( 251)		::MainMenuState_obj::curSelected = (::MainMenuState_obj::curSelected + huh);
HXLINE( 253)		if ((::MainMenuState_obj::curSelected >= this->menuItems->length)) {
HXLINE( 254)			::MainMenuState_obj::curSelected = 0;
            		}
HXLINE( 255)		if ((::MainMenuState_obj::curSelected < 0)) {
HXLINE( 256)			::MainMenuState_obj::curSelected = (this->menuItems->length - 1);
            		}
HXLINE( 258)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
