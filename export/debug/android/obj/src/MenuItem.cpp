...
HXDLIN(  17)		this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("storymenu/",9b,19,38,af) + weekName)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
