...
HX_LOCAL_STACK_FRAME(_hx_pos_f93022dfbe651d27_261_update,"StoryMenuState","update",0xb708d8fa,"StoryMenuState.update","StoryMenuState.hx",261,0xd8e12181)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f93022dfbe651d27_271_selectWeek,"StoryMenuState","selectWeek",0x4a36f481,"StoryMenuState.selectWeek","StoryMenuState.hx",271,0xd8e12181)
HX_LOCAL_STACK_FRAME(_hx_pos_f93022dfbe651d27_304_selectWeek,"StoryMenuState","selectWeek",0x4a36f481,"StoryMenuState.selectWeek","StoryMenuState.hx",304,0xd8e12181)
HX_LOCAL_STACK_FRAME(_hx_pos_f93022dfbe651d27_322_changeDifficulty,"StoryMenuState","changeDifficulty",0xd5c0d9fc,"StoryMenuState.changeDifficulty","StoryMenuState.hx",322,0xd8e12181)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f93022dfbe651d27_341_changeWeek,"StoryMenuState","changeWeek",0xb5e4b4f5,"StoryMenuState.changeWeek","StoryMenuState.hx",341,0xd8e12181)
HX_LOCAL_STACK_FRAME(_hx_pos_f93022dfbe651d27_378_weekIsLocked,"StoryMenuState","weekIsLocked",0x95e86e59,"StoryMenuState.weekIsLocked","StoryMenuState.hx",378,0xd8e12181)
HX_LOCAL_STACK_FRAME(_hx_pos_f93022dfbe651d27_384_updateText,"StoryMenuState","updateText",0x9254d6c7,"StoryMenuState.updateText","StoryMenuState.hx",384,0xd8e12181)
...
HXLINE( 338)		this->intendedScore = 0;
HXLINE( 337)		this->lerpScore = 0;
HXLINE( 267)		this->stopspamming = false;
HXLINE( 266)		this->selectedWeek = false;
HXLINE( 265)		this->movedBack = false;
...
HXDLIN(  74)		 ::Dynamic ui_tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("campaign_menu_UI_assets",fd,f3,ba,6a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  74)		 ::flixel::graphics::frames::FlxAtlasFrames ui_tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(ui_tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("campaign_menu_UI_assets",fd,f3,ba,6a)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
...
HXLINE( 133)		this->leftArrow->set_frames(ui_tex1);
...
HXDLIN( 145)				 ::flixel::FlxSprite sprDifficulty1 = sprDifficulty->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("menudifficulties/",b7,09,b6,65) + ::CoolUtil_obj::difficultyStuff->__get(i)->__GetItem(0)->__Field(HX_("toLowerCase",56,4c,64,b8),::hx::paccDynamic)())) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE( 146)				Float sprDifficulty2 = sprDifficulty1->x;
HXDLIN( 146)				sprDifficulty1->set_x((sprDifficulty2 + ((( (Float)(308) ) - sprDifficulty1->get_width()) / ( (Float)(2) ))));
HXLINE( 147)				sprDifficulty1->ID = i;
HXLINE( 148)				sprDifficulty1->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 149)				this->sprDifficultyGroup->add(sprDifficulty1).StaticCast<  ::flixel::FlxSprite >();
            			}
            		}
...
HXLINE( 156)		this->rightArrow->set_frames(ui_tex1);
...
HXDLIN( 167)		 ::flixel::FlxSprite tracksSprite1 = tracksSprite->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Menu_Tracks",68,85,99,50)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE( 168)		tracksSprite1->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 169)		this->add(tracksSprite1);
HXLINE( 171)		this->txtTracklist =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.05)),(tracksSprite1->y + 60),0,HX_("",00,00,00,00),32,null());
...
HXLINE( 184)		this->addVirtualPad(::ui::FlxDPadMode_obj::FULL_dyn(),::ui::FlxActionMode_obj::A_B_dyn());
...
void StoryMenuState_obj::update(Float elapsed){
            		...
            		void _hx_run( ::flixel::FlxSprite lock){
            			HX_GC_STACKFRAME(&_hx_pos_f93022dfbe651d27_261_update)
HXLINE( 261)			lock->set_y(Dynamic( _gthis->grpWeekText->members->__get(lock->ID)).StaticCast<  ::MenuItem >()->y);
            		}
...
HXDLIN( 200)		Float b = ( (Float)(this->intendedScore) );
HXDLIN( 200)		this->lerpScore = ::Math_obj::floor((a + (::CoolUtil_obj::boundTo((elapsed * ( (Float)(30) )),( (Float)(0) ),( (Float)(1) )) * (b - a))));
...
HXLINE( 207)		 ::flixel::group::FlxTypedGroup _hx_tmp = this->difficultySelectors;
HXDLIN( 207)		_hx_tmp->set_visible(!(this->weekIsLocked(::StoryMenuState_obj::curWeek)));
HXLINE( 209)		bool _hx_tmp1;
HXDLIN( 209)		if (!(this->movedBack)) {
HXLINE( 209)			_hx_tmp1 = !(this->selectedWeek);
            		}
            		else {
...
HXLINE( 240)				this->selectWeek();
            			}
            			else {
HXLINE( 242)				if (::PlayerSettings_obj::player1->controls->_reset->check()) {
HXLINE( 244)					this->persistentUpdate = false;
HXLINE( 245)					this->openSubState( ::ResetScoreSubState_obj::__alloc( HX_CTX ,HX_("",00,00,00,00),::StoryMenuState_obj::curDifficulty,HX_("",00,00,00,00),::StoryMenuState_obj::curWeek));
...
HXDLIN( 250)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 250)			_hx_tmp3 = !(this->movedBack);
            		}
            		else {
HXLINE( 250)			_hx_tmp3 = false;
            		}
HXDLIN( 250)		if (_hx_tmp3) {
HXLINE( 250)			_hx_tmp2 = !(this->selectedWeek);
            		}
            		else {
...
HXDLIN( 252)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 253)			this->movedBack = true;
HXLINE( 254)			::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 257)		this->super::update(elapsed);
HXLINE( 259)		this->grpLocks->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}


void StoryMenuState_obj::selectWeek(){
            	HX_GC_STACKFRAME(&_hx_pos_f93022dfbe651d27_271_selectWeek)
HXDLIN( 271)		if (!(this->weekIsLocked(::StoryMenuState_obj::curWeek))) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_GC_STACKFRAME(&_hx_pos_f93022dfbe651d27_304_selectWeek)
HXLINE( 305)				::MusicBeatState_obj::switchState(::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),true));
HXLINE( 306)				::FreeplayState_obj::destroyFreeplayVocals();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 273)			if ((this->stopspamming == false)) {
HXLINE( 275)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 275)				_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 277)				Dynamic( this->grpWeekText->members->__get(::StoryMenuState_obj::curWeek)).StaticCast<  ::MenuItem >()->startFlashing();
HXLINE( 278)				if ((Dynamic( this->grpWeekCharacters->members->__get(1)).StaticCast<  ::MenuCharacter >()->character != HX_("",00,00,00,00))) {
HXLINE( 278)					Dynamic( this->grpWeekCharacters->members->__get(1)).StaticCast<  ::MenuCharacter >()->animation->play(HX_("confirm",00,9d,39,10),null(),null(),null());
            				}
HXLINE( 279)				this->stopspamming = true;
            			}
HXLINE( 283)			::Array< ::String > songArray = ::Array_obj< ::String >::__new(0);
HXLINE( 284)			::cpp::VirtualArray leWeek = ( ( ::WeekData)(::WeekData_obj::weeksLoaded->get(::WeekData_obj::weeksList->__get(::StoryMenuState_obj::curWeek))) )->songs;
HXLINE( 285)			{
HXLINE( 285)				int _g = 0;
HXDLIN( 285)				int _g1 = leWeek->get_length();
HXDLIN( 285)				while((_g < _g1)){
HXLINE( 285)					_g = (_g + 1);
HXDLIN( 285)					int i = (_g - 1);
HXLINE( 286)					songArray->push(leWeek->__get(i)->__GetItem(0));
            				}
            			}
HXLINE( 290)			::PlayState_obj::storyPlaylist = songArray;
HXLINE( 291)			::PlayState_obj::isStoryMode = true;
HXLINE( 292)			this->selectedWeek = true;
HXLINE( 294)			::String diffic = ( (::String)(::CoolUtil_obj::difficultyStuff->__get(::StoryMenuState_obj::curDifficulty)->__GetItem(1)) );
HXLINE( 295)			if (::hx::IsNull( diffic )) {
HXLINE( 295)				diffic = HX_("",00,00,00,00);
            			}
HXLINE( 297)			::PlayState_obj::storyDifficulty = ::StoryMenuState_obj::curDifficulty;
HXLINE( 299)			::String _hx_tmp = (::PlayState_obj::storyPlaylist->__get(0).toLowerCase() + diffic);
HXDLIN( 299)			::PlayState_obj::SONG = ::Song_obj::loadFromJson(_hx_tmp,::PlayState_obj::storyPlaylist->__get(0).toLowerCase());
HXLINE( 300)			::PlayState_obj::storyWeek = ::StoryMenuState_obj::curWeek;
HXLINE( 301)			::PlayState_obj::campaignScore = 0;
HXLINE( 302)			::PlayState_obj::campaignMisses = 0;
...
HXDLIN( 309)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
            		}
            	}
...
void StoryMenuState_obj::changeDifficulty(::hx::Null< int >  __o_change){
            		...
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_f93022dfbe651d27_322_changeDifficulty)
HXLINE( 323)			spr->set_visible(false);
HXLINE( 324)			if ((::StoryMenuState_obj::curDifficulty == spr->ID)) {
HXLINE( 325)				spr->set_visible(true);
HXLINE( 326)				spr->set_alpha(( (Float)(0) ));
HXLINE( 327)				spr->set_y((_gthis->leftArrow->y - ( (Float)(15) )));
...
HXDLIN( 314)		 ::StoryMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 315)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::StoryMenuState >();
HXDLIN( 315)		::StoryMenuState_obj::curDifficulty = (::StoryMenuState_obj::curDifficulty + change);
HXLINE( 317)		if ((::StoryMenuState_obj::curDifficulty < 0)) {
HXLINE( 318)			::StoryMenuState_obj::curDifficulty = (::CoolUtil_obj::difficultyStuff->get_length() - 1);
            		}
HXLINE( 319)		if ((::StoryMenuState_obj::curDifficulty >= ::CoolUtil_obj::difficultyStuff->get_length())) {
HXLINE( 320)			::StoryMenuState_obj::curDifficulty = 0;
            		}
HXLINE( 322)		this->sprDifficultyGroup->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
HXLINE( 333)		this->intendedScore = ::Highscore_obj::getWeekScore(::WeekData_obj::weeksList->__get(::StoryMenuState_obj::curWeek),::StoryMenuState_obj::curDifficulty);
            	}
...
void StoryMenuState_obj::changeWeek(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_STACKFRAME(&_hx_pos_f93022dfbe651d27_341_changeWeek)
HXLINE( 342)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::StoryMenuState >();
HXDLIN( 342)		::StoryMenuState_obj::curWeek = (::StoryMenuState_obj::curWeek + change);
HXLINE( 344)		if ((::StoryMenuState_obj::curWeek >= ::WeekData_obj::weeksList->length)) {
HXLINE( 345)			::StoryMenuState_obj::curWeek = 0;
            		}
HXLINE( 346)		if ((::StoryMenuState_obj::curWeek < 0)) {
HXLINE( 347)			::StoryMenuState_obj::curWeek = (::WeekData_obj::weeksList->length - 1);
            		}
HXLINE( 349)		 ::WeekData leWeek = ( ( ::WeekData)(::WeekData_obj::weeksLoaded->get(::WeekData_obj::weeksList->__get(::StoryMenuState_obj::curWeek))) );
HXLINE( 350)		::WeekData_obj::setDirectoryFromWeek(leWeek);
HXLINE( 352)		::String leName = leWeek->storyName;
HXLINE( 353)		 ::flixel::text::FlxText _hx_tmp1 = this->txtWeekTitle;
HXDLIN( 353)		_hx_tmp1->set_text(leName.toUpperCase());
HXLINE( 354)		 ::flixel::text::FlxText _hx_tmp2 = this->txtWeekTitle;
HXDLIN( 354)		int _hx_tmp3 = ::flixel::FlxG_obj::width;
HXDLIN( 354)		_hx_tmp2->set_x((( (Float)(_hx_tmp3) ) - (this->txtWeekTitle->get_width() + 10)));
...
HXDLIN( 358)				_g = (_g + 1);
HXLINE( 360)				item->targetY = ( (Float)((bullShit - ::StoryMenuState_obj::curWeek)) );
HXLINE( 361)				bool _hx_tmp;
HXDLIN( 361)				if ((item->targetY == 0)) {
HXLINE( 361)					_hx_tmp = !(this->weekIsLocked(::StoryMenuState_obj::curWeek));
            				}
            				else {
...
HXLINE( 368)		this->bgSprite->set_visible(true);
HXLINE( 369)		::String assetName = leWeek->weekBackground;
HXLINE( 370)		bool _hx_tmp4;
HXDLIN( 370)		if (::hx::IsNotNull( assetName )) {
HXLINE( 370)			_hx_tmp4 = (assetName.length < 1);
            		}
            		else {
HXLINE( 370)			_hx_tmp4 = true;
            		}
HXDLIN( 370)		if (_hx_tmp4) {
HXLINE( 371)			this->bgSprite->set_visible(false);
            		}
            		else {
HXLINE( 373)			 ::flixel::FlxSprite _hx_tmp = this->bgSprite;
HXDLIN( 373)			::String library = null();
HXDLIN( 373)			_hx_tmp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("menubackgrounds/menu_",57,51,99,49) + assetName)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
            		}
...
bool StoryMenuState_obj::weekIsLocked(int weekNum){
            	HX_STACKFRAME(&_hx_pos_f93022dfbe651d27_378_weekIsLocked)
HXLINE( 379)		 ::WeekData leWeek = ( ( ::WeekData)(::WeekData_obj::weeksLoaded->get(::WeekData_obj::weeksList->__get(weekNum))) );
HXLINE( 380)		bool _hx_tmp;
HXDLIN( 380)		if (!(leWeek->startUnlocked)) {
HXLINE( 380)			_hx_tmp = (leWeek->weekBefore.length > 0);
            		}
            		else {
HXLINE( 380)			_hx_tmp = false;
            		}
HXDLIN( 380)		if (_hx_tmp) {
HXLINE( 380)			if (::StoryMenuState_obj::weekCompleted->exists(leWeek->weekBefore)) {
HXLINE( 380)				return !(::StoryMenuState_obj::weekCompleted->get_bool(leWeek->weekBefore));
            			}
            			else {
...
void StoryMenuState_obj::updateText(){
            	HX_STACKFRAME(&_hx_pos_f93022dfbe651d27_384_updateText)
HXLINE( 385)		::Array< ::String > weekArray = ( ( ::WeekData)(::WeekData_obj::weeksLoaded->get(::WeekData_obj::weeksList->__get(::StoryMenuState_obj::curWeek))) )->weekCharacters;
HXLINE( 386)		{
HXLINE( 386)			int _g = 0;
HXDLIN( 386)			int _g1 = this->grpWeekCharacters->length;
HXDLIN( 386)			while((_g < _g1)){
HXLINE( 386)				_g = (_g + 1);
HXDLIN( 386)				int i = (_g - 1);
HXLINE( 387)				Dynamic( this->grpWeekCharacters->members->__get(i)).StaticCast<  ::MenuCharacter >()->changeCharacter(weekArray->__get(i));
            			}
            		}
HXLINE( 390)		 ::WeekData leWeek = ( ( ::WeekData)(::WeekData_obj::weeksLoaded->get(::WeekData_obj::weeksList->__get(::StoryMenuState_obj::curWeek))) );
HXLINE( 391)		::Array< ::String > stringThing = ::Array_obj< ::String >::__new(0);
HXLINE( 392)		{
HXLINE( 392)			int _g2 = 0;
HXDLIN( 392)			int _g3 = leWeek->songs->get_length();
HXDLIN( 392)			while((_g2 < _g3)){
HXLINE( 392)				_g2 = (_g2 + 1);
HXDLIN( 392)				int i = (_g2 - 1);
HXLINE( 393)				stringThing->push(leWeek->songs->__get(i)->__GetItem(0));
            			}
            		}
HXLINE( 396)		this->txtTracklist->set_text(HX_("",00,00,00,00));
HXLINE( 397)		{
HXLINE( 397)			int _g4 = 0;
HXDLIN( 397)			int _g5 = stringThing->length;
HXDLIN( 397)			while((_g4 < _g5)){
HXLINE( 397)				_g4 = (_g4 + 1);
HXDLIN( 397)				int i = (_g4 - 1);
HXLINE( 399)				 ::flixel::text::FlxText fh = this->txtTracklist;
HXDLIN( 399)				fh->set_text((fh->text + (stringThing->__get(i) + HX_("\n",0a,00,00,00))));
            			}
            		}
HXLINE( 402)		 ::flixel::text::FlxText _hx_tmp = this->txtTracklist;
HXDLIN( 402)		_hx_tmp->set_text(this->txtTracklist->text.toUpperCase());
HXLINE( 404)		this->txtTracklist->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 405)		 ::flixel::text::FlxText fh = this->txtTracklist;
HXDLIN( 405)		fh->set_x((fh->x - (( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.35))));
HXLINE( 408)		this->intendedScore = ::Highscore_obj::getWeekScore(::WeekData_obj::weeksList->__get(::StoryMenuState_obj::curWeek),::StoryMenuState_obj::curDifficulty);
            	}
