...
HXLINE(  66)			if (!(::openfl::utils::Assets_obj::exists(path,null()))) {
HXLINE(  67)				::String file = ((HX_("images/menucharacters/",6f,fa,bf,a6) + ::MenuCharacter_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN(  67)				if (::hx::IsNull( file )) {
HXLINE(  67)					file = HX_("",00,00,00,00);
            				}
HXDLIN(  67)				path = (HX_("assets/",4c,2a,dc,36) + file);
            			}
HXLINE(  69)			rawJson = ::openfl::utils::Assets_obj::getText(path);
...
HXDLIN(  73)			 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  73)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
