...
HXDLIN(  30)			this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("pixelUI/",95,50,4f,7e) + skin)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
...
HXDLIN(  33)			 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("pixelUI/",95,50,4f,7e) + skin)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN(  33)			int _hx_tmp1 = ::Math_obj::floor(this->get_width());
HXDLIN(  33)			this->loadGraphic(_hx_tmp,true,_hx_tmp1,::Math_obj::floor(this->get_height()),null(),null());
...
HXLINE(  40)			Float _hx_tmp2 = this->get_width();
HXDLIN(  40)			this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp2 * ::PlayState_obj::daPixelZoom)),null());
...
HXDLIN(  64)			 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  64)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
