...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1377_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",1377,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1389_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",1389,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1377_new)
HXLINE(1379)		this->disableTime = ((Float)6);
HXLINE(1382)		this->parentGroup = parentGroup;
HXLINE(1383)		super::__construct(10,10,0,text,16,null());
HXLINE(1384)		this->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(1385)		this->scrollFactor->set(null(),null());
HXLINE(1386)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1389_update)
HXLINE(1390)		this->super::update(elapsed);
HXLINE(1391)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1391)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(1392)		if ((this->disableTime <= 0)) {
HXLINE(1393)			this->kill();
HXLINE(1394)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(1395)			this->destroy();
            		}
            		else {
HXLINE(1397)			if ((this->disableTime < 1)) {
HXLINE(1397)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
