...
HX_DEFINE_STACK_FRAME(_hx_pos_ec6539926560d3c0_84_new,"AttachedAchievement","new",0x78b415bd,"AttachedAchievement.new","Achievements.hx",84,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_91_changeAchievement,"AttachedAchievement","changeAchievement",0x3f6c6afc,"AttachedAchievement.changeAchievement","Achievements.hx",91,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_96_reloadAchievementImage,"AttachedAchievement","reloadAchievementImage",0x2581b6a8,"AttachedAchievement.reloadAchievementImage","Achievements.hx",96,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_ec6539926560d3c0_108_update,"AttachedAchievement","update",0x63d738cc,"AttachedAchievement.update","Achievements.hx",108,0xf249f7fa)

void AttachedAchievement_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::String name){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_84_new)
HXLINE(  85)		super::__construct(x,y,null());
HXLINE(  87)		this->changeAchievement(name);
...
void AttachedAchievement_obj::changeAchievement(::String tag){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_91_changeAchievement)
HXLINE(  92)		this->tag = tag;
HXLINE(  93)		this->reloadAchievementImage();
            	}
...
void AttachedAchievement_obj::reloadAchievementImage(){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_96_reloadAchievementImage)
HXLINE(  97)		if (::Achievements_obj::isAchievementUnlocked(this->tag)) {
HXLINE(  98)			::String library = null();
HXDLIN(  98)			this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("achievementgrid",b5,fa,02,8a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),true,150,150,null(),null());
HXLINE(  99)			 ::flixel::animation::FlxAnimationController _hx_tmp = this->animation;
HXDLIN(  99)			_hx_tmp->add(HX_("icon",79,e7,b2,45),::Array_obj< int >::__new(1)->init(0,::Achievements_obj::getAchievementIndex(this->tag)),0,false,false,null());
HXLINE( 100)			this->animation->play(HX_("icon",79,e7,b2,45),null(),null(),null());
            		}
            		else {
HXLINE( 102)			::String library = null();
HXDLIN( 102)			this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("lockedachievement",a5,23,f4,2a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
            		}
HXLINE( 104)		this->scale->set(((Float)0.7),((Float)0.7));
...
void AttachedAchievement_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ec6539926560d3c0_108_update)
HXLINE( 109)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE( 110)			this->setPosition((this->sprTracker->x - ( (Float)(130) )),(this->sprTracker->y + 25));
            		}
