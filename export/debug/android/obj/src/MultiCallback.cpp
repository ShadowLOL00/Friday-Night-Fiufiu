...
HX_DEFINE_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_264_new,"MultiCallback","new",0x3682e930,"MultiCallback.new","LoadingState.hx",264,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_288_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",288,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_281_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",281,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_313_log,"MultiCallback","log",0x36816d54,"MultiCallback.log","LoadingState.hx",313,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_317_getFired,"MultiCallback","getFired",0x1ac970a8,"MultiCallback.getFired","LoadingState.hx",317,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_318_getUnfired,"MultiCallback","getUnfired",0xfdf08a2f,"MultiCallback.getUnfired","LoadingState.hx",318,0x53ff9bc9)

void MultiCallback_obj::__construct( ::Dynamic callback,::String logId){
            	HX_GC_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_264_new)
...
bool MultiCallback_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic MultiCallback_obj::add(::String __o_id){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_288_add)
...
HXLINE( 295)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id1->__get(0)) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),314,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 297)				if ((_gthis->numRemaining == 0)) {
HXLINE( 299)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 300)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 300)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),314,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            						}
            					}
...
HXLINE( 305)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id1->__get(0))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),314,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            				}
            			}
            		}
            	...
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_281_add)
HXDLIN( 281)		::Array< ::String > id1 = ::Array_obj< ::String >::__new(1)->init(0,id);
HXDLIN( 281)		 ::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
void MultiCallback_obj::log(::String msg){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_313_log)
HXDLIN( 313)		if (::hx::IsNotNull( this->logId )) {
HXLINE( 314)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),314,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            		}
            	}
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_317_getFired)
...
::Array< ::String > MultiCallback_obj::getUnfired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_318_getUnfired)
