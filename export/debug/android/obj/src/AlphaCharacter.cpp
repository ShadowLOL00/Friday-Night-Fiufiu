...
HX_DEFINE_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_371_new,"AlphaCharacter","new",0xcdf30efd,"AlphaCharacter.new","Alphabet.hx",371,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_396_createBoldLetter,"AlphaCharacter","createBoldLetter",0xb921b5aa,"AlphaCharacter.createBoldLetter","Alphabet.hx",396,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_403_createBoldNumber,"AlphaCharacter","createBoldNumber",0xb7938f8d,"AlphaCharacter.createBoldNumber","Alphabet.hx",403,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_410_createBoldSymbol,"AlphaCharacter","createBoldSymbol",0x04f6b81c,"AlphaCharacter.createBoldSymbol","Alphabet.hx",410,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_453_createLetter,"AlphaCharacter","createLetter",0xc29272c5,"AlphaCharacter.createLetter","Alphabet.hx",453,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_469_createNumber,"AlphaCharacter","createNumber",0xc1044ca8,"AlphaCharacter.createNumber","Alphabet.hx",469,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_480_createSymbol,"AlphaCharacter","createSymbol",0x0e677537,"AlphaCharacter.createSymbol","Alphabet.hx",480,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_0b74b60e7bf66d88_373_boot,"AlphaCharacter","boot",0x5ed30ef5,"AlphaCharacter.boot","Alphabet.hx",373,0xc2e40fcb)
...
void AlphaCharacter_obj::__construct(Float x,Float y,Float textSize){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_371_new)
HXLINE( 381)		this->textSize = ((Float)1);
HXLINE( 379)		this->row = 0;
HXLINE( 385)		super::__construct(x,y,null());
HXLINE( 386)		::String library = null();
HXDLIN( 386)		 ::Dynamic tex = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("alphabet",b3,7c,38,21)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 386)		 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("alphabet",b3,7c,38,21)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 387)		this->set_frames(tex1);
HXLINE( 389)		this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * textSize)),null());
HXLINE( 390)		this->updateHitbox();
HXLINE( 391)		this->textSize = textSize;
HXLINE( 392)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            	}
...
void AlphaCharacter_obj::createBoldLetter(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_396_createBoldLetter)
HXLINE( 397)		 ::flixel::animation::FlxAnimationController _hx_tmp = this->animation;
HXDLIN( 397)		_hx_tmp->addByPrefix(letter,(letter.toUpperCase() + HX_(" bold",a5,11,ee,ad)),24,null(),null(),null());
...
void AlphaCharacter_obj::createBoldNumber(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_403_createBoldNumber)
HXLINE( 404)		this->animation->addByPrefix(letter,(HX_("bold",85,81,1b,41) + letter),24,null(),null(),null());
HXLINE( 405)		this->animation->play(letter,null(),null(),null());
...
void AlphaCharacter_obj::createBoldSymbol(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_410_createBoldSymbol)
HXLINE( 411)		::String _hx_switch_0 = letter;
            		if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 420)			this->animation->addByPrefix(letter,HX_("EXCLAMATION POINT bold",e8,54,4d,e9),24,null(),null(),null());
HXDLIN( 420)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("'",27,00,00,00)) ){
HXLINE( 416)			this->animation->addByPrefix(letter,HX_("APOSTRAPHIE bold",41,48,86,a1),24,null(),null(),null());
HXDLIN( 416)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("(",28,00,00,00)) ){
HXLINE( 422)			this->animation->addByPrefix(letter,HX_("bold (",cd,c8,22,60),24,null(),null(),null());
HXDLIN( 422)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_(")",29,00,00,00)) ){
HXLINE( 424)			this->animation->addByPrefix(letter,HX_("bold )",ce,c8,22,60),24,null(),null(),null());
HXDLIN( 424)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_(".",2e,00,00,00)) ){
HXLINE( 414)			this->animation->addByPrefix(letter,HX_("PERIOD bold",04,41,9c,ad),24,null(),null(),null());
HXDLIN( 414)			goto _hx_goto_3;
            		}
            		if (  (_hx_switch_0==HX_("?",3f,00,00,00)) ){
HXLINE( 418)			this->animation->addByPrefix(letter,HX_("QUESTION MARK bold",fe,8c,0a,9b),24,null(),null(),null());
HXDLIN( 418)			goto _hx_goto_3;
            		}
            		/* default */{
HXLINE( 426)			this->animation->addByPrefix(letter,(HX_("bold ",fb,d2,f5,b6) + letter),24,null(),null(),null());
            		}
            		_hx_goto_3:;
HXLINE( 428)		this->animation->play(letter,null(),null(),null());
HXLINE( 429)		this->updateHitbox();
HXLINE( 430)		::String _hx_switch_1 = letter;
            		if (  (_hx_switch_1==HX_("'",27,00,00,00)) ){
HXLINE( 433)			this->set_y((this->y - (( (Float)(20) ) * this->textSize)));
HXDLIN( 433)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_("(",28,00,00,00)) ){
HXLINE( 438)			this->set_x((this->x - (( (Float)(65) ) * this->textSize)));
HXLINE( 439)			this->set_y((this->y - (( (Float)(5) ) * this->textSize)));
HXLINE( 440)			this->offset->set_x((( (Float)(-58) ) * this->textSize));
HXLINE( 437)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_(")",29,00,00,00)) ){
HXLINE( 442)			this->set_x((this->x - (( (Float)(20) ) / this->textSize)));
HXLINE( 443)			this->set_y((this->y - (( (Float)(5) ) * this->textSize)));
HXLINE( 444)			this->offset->set_x((( (Float)(12) ) * this->textSize));
HXLINE( 441)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_("-",2d,00,00,00)) ){
HXLINE( 436)			this->set_y((this->y + (( (Float)(20) ) * this->textSize)));
HXDLIN( 436)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_(".",2e,00,00,00)) ){
HXLINE( 446)			this->set_y((this->y + (( (Float)(45) ) * this->textSize)));
HXLINE( 447)			this->set_x((this->x + (( (Float)(5) ) * this->textSize)));
HXLINE( 448)			 ::flixel::math::FlxPoint fh = this->offset;
HXDLIN( 448)			fh->set_x((fh->x + (( (Float)(3) ) * this->textSize)));
HXLINE( 445)			goto _hx_goto_4;
            		}
            		_hx_goto_4:;
            	}
...
void AlphaCharacter_obj::createLetter(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_453_createLetter)
HXLINE( 454)		::String letterCase = HX_("lowercase",31,ad,a5,66);
HXLINE( 455)		if ((letter.toLowerCase() != letter)) {
HXLINE( 457)			letterCase = HX_("capital",a8,a6,0b,a0);
            		}
HXLINE( 460)		this->animation->addByPrefix(letter,((letter + HX_(" ",20,00,00,00)) + letterCase),24,null(),null(),null());
HXLINE( 461)		this->animation->play(letter,null(),null(),null());
...
void AlphaCharacter_obj::createNumber(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_469_createNumber)
HXLINE( 470)		this->animation->addByPrefix(letter,letter,24,null(),null(),null());
HXLINE( 471)		this->animation->play(letter,null(),null(),null());
HXLINE( 473)		this->updateHitbox();
HXLINE( 475)		this->set_y((( (Float)(110) ) - this->get_height()));
HXLINE( 476)		this->set_y((this->y + (this->row * 60)));
            	}
...
void AlphaCharacter_obj::createSymbol(::String letter){
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_480_createSymbol)
HXLINE( 481)		::String _hx_switch_0 = letter;
            		if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 493)			this->animation->addByPrefix(letter,HX_("exclamation point",dd,17,c1,eb),24,null(),null(),null());
HXDLIN( 493)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("#",23,00,00,00)) ){
HXLINE( 484)			this->animation->addByPrefix(letter,HX_("hashtag",4c,7f,81,29),24,null(),null(),null());
HXDLIN( 484)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("'",27,00,00,00)) ){
HXLINE( 488)			this->animation->addByPrefix(letter,HX_("apostraphie",04,43,cf,ad),24,null(),null(),null());
HXLINE( 489)			this->set_y((this->y - ( (Float)(50) )));
HXLINE( 487)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_(",",2c,00,00,00)) ){
HXLINE( 495)			this->animation->addByPrefix(letter,HX_("comma",d5,31,5d,4a),24,null(),null(),null());
HXDLIN( 495)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_(".",2e,00,00,00)) ){
HXLINE( 486)			this->animation->addByPrefix(letter,HX_("period",01,61,1b,3b),24,null(),null(),null());
HXDLIN( 486)			goto _hx_goto_8;
            		}
            		if (  (_hx_switch_0==HX_("?",3f,00,00,00)) ){
HXLINE( 491)			this->animation->addByPrefix(letter,HX_("question mark",47,0b,f6,d2),24,null(),null(),null());
HXDLIN( 491)			goto _hx_goto_8;
            		}
            		/* default */{
HXLINE( 497)			this->animation->addByPrefix(letter,letter,24,null(),null(),null());
            		}
            		_hx_goto_8:;
HXLINE( 499)		this->animation->play(letter,null(),null(),null());
HXLINE( 501)		this->updateHitbox();
HXLINE( 503)		this->set_y((( (Float)(110) ) - this->get_height()));
HXLINE( 504)		this->set_y((this->y + (this->row * 60)));
HXLINE( 505)		::String _hx_switch_1 = letter;
            		if (  (_hx_switch_1==HX_("'",27,00,00,00)) ){
HXLINE( 508)			this->set_y((this->y - ( (Float)(20) )));
HXDLIN( 508)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_1==HX_("-",2d,00,00,00)) ){
HXLINE( 511)			this->set_y((this->y - ( (Float)(16) )));
...
{
{
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_373_boot)
HXDLIN( 373)		alphabet = HX_("abcdefghijklmnopqrstuvwxyz",6d,97,f1,fb);
            	}
{
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_375_boot)
HXDLIN( 375)		numbers = HX_("1234567890",5b,2e,e3,45);
            	}
{
            	HX_STACKFRAME(&_hx_pos_0b74b60e7bf66d88_377_boot)
HXDLIN( 377)		symbols = HX_("|~#$%()*+-:;<=>@[]^_.,'!?",f7,99,8c,d3);
            	}
}
