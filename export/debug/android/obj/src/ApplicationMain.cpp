...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("49",85,2d,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("teamsilver",6a,e1,97,73));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("PsychEngine",3d,1b,63,8f));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("MAL-TE-VI Picante",a2,bb,0a,ce));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.teamsilver.maltevi",85,ce,34,9d));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("1.5",b8,56,25,00));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("MAL-TE-VI Picante",a2,bb,0a,ce))
