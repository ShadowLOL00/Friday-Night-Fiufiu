...
static const ::String _hx_array_data_0344a85e_7[] = {
	HX_("assets/",4c,2a,dc,36),
};
...
HXLINE(  93)		::Array< ::String > directories = ::Array_obj< ::String >::fromData( _hx_array_data_0344a85e_7,1);
HXLINE(  94)		int originalLength = directories->length;
...
HXLINE( 157)		if (::openfl::utils::Assets_obj::exists(path,null())) {
HXLINE( 158)			rawJson = ::lime::utils::Assets_obj::getText(path);
            		}
