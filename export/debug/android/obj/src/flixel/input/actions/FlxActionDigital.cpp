...
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_144_addAndroidKey,"flixel.input.actions.FlxActionDigital","addAndroidKey",0xf12395da,"flixel.input.actions.FlxActionDigital.addAndroidKey","flixel/input/actions/FlxAction.hx",144,0xb046b220)
...
HX_DEFINE_DYNAMIC_FUNC2(FlxActionDigital_obj,addMouseWheel,return )
 ...
 ::flixel::input::actions::FlxActionDigital FlxActionDigital_obj::addAndroidKey(int Key,int Trigger){
            	HX_GC_STACKFRAME(&_hx_pos_740854858cd8efa1_144_addAndroidKey)
HXDLIN( 144)		return this->add( ::flixel::input::actions::FlxActionInputDigitalAndroid_obj::__alloc( HX_CTX ,Key,Trigger));
            	}


HX_DEFINE_DYNAMIC_FUNC2(FlxActionDigital_obj,addAndroidKey,return )
...
::hx::Val FlxActionDigital_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"addAndroidKey") ) { return ::hx::Val( addAndroidKey_dyn() ); }
	}
