...
HX_LOCAL_STACK_FRAME(_hx_pos_ff18a02f3055fb45_31_add_flixel_input_android_FlxAndroidKeys,"flixel.system.frontEnds.InputFrontEnd","add_flixel_input_android_FlxAndroidKeys",0x46ee914f,"flixel.system.frontEnds.InputFrontEnd.add_flixel_input_android_FlxAndroidKeys","flixel/system/frontEnds/InputFrontEnd.hx",31,0x759f67bd)
...
HX_DEFINE_DYNAMIC_FUNC1(InputFrontEnd_obj,add_flixel_input_actions_FlxActionManager,return )
 ...
 ::flixel::input::android::FlxAndroidKeys InputFrontEnd_obj::add_flixel_input_android_FlxAndroidKeys( ::flixel::input::android::FlxAndroidKeys Input){
            	HX_STACKFRAME(&_hx_pos_ff18a02f3055fb45_31_add_flixel_input_android_FlxAndroidKeys)
HXLINE(  33)		{
HXLINE(  33)			int _g = 0;
HXDLIN(  33)			::Array< ::Dynamic> _g1 = this->list;
HXDLIN(  33)			while((_g < _g1->length)){
