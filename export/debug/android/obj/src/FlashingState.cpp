...
HX_LOCAL_STACK_FRAME(_hx_pos_fe772f19f43355ce_33_update,"FlashingState","update",0x625bfb38,"FlashingState.update","FlashingState.hx",33,0xb3aaccbf)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fe772f19f43355ce_45_update,"FlashingState","update",0x625bfb38,"FlashingState.update","FlashingState.hx",45,0xb3aaccbf)
HX_LOCAL_STACK_FRAME(_hx_pos_fe772f19f43355ce_53_update,"FlashingState","update",0x625bfb38,"FlashingState.update","FlashingState.hx",53,0xb3aaccbf)
...
HXDLIN(  26)		this->warnText = _hx_tmp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("WARN",46,2a,b3,39)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE(  27)		 ::flixel::FlxSprite _hx_tmp1 = this->warnText;
HXDLIN(  27)		_hx_tmp1->setGraphicSize(::Std_obj::_hx_int((this->warnText->get_width() * ((Float)0.9))),null());
HXLINE(  28)		this->warnText->screenCenter(::flixel::util::FlxAxes_obj::XY_dyn());
HXLINE(  29)		this->add(this->warnText);
            	}


void FlashingState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_fe772f19f43355ce_33_update)
HXLINE(  34)		if (!(::FlashingState_obj::leftState)) {
HXLINE(  35)			bool back = ::PlayerSettings_obj::player1->controls->_back->check();
HXLINE(  36)			bool _hx_tmp;
HXDLIN(  36)			if (!(::PlayerSettings_obj::player1->controls->_accept->check())) {
HXLINE(  36)				_hx_tmp = back;
            			}
            			else {
HXLINE(  36)				_hx_tmp = true;
            			}
HXDLIN(  36)			if (_hx_tmp) {
HXLINE(  37)				::FlashingState_obj::leftState = true;
HXLINE(  38)				::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransIn = true;
HXLINE(  39)				::flixel::addons::transition::FlxTransitionableState_obj::skipNextTransOut = true;
HXLINE(  40)				if (!(back)) {
            					HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            					void _hx_run( ::flixel::effects::FlxFlicker flk){
            						HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            						void _hx_run( ::flixel::util::FlxTimer tmr){
            							HX_GC_STACKFRAME(&_hx_pos_fe772f19f43355ce_46_update)
HXLINE(  46)							::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            						}
            						HX_END_LOCAL_FUNC1((void))

            						HX_GC_STACKFRAME(&_hx_pos_fe772f19f43355ce_45_update)
HXLINE(  45)						 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.5), ::Dynamic(new _hx_Closure_0()),null());
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE(  41)					::ClientPrefs_obj::flashing = false;
HXLINE(  42)					::ClientPrefs_obj::saveSettings();
...
HXLINE(  44)					::flixel::effects::FlxFlicker_obj::flicker(this->warnText,1,((Float)0.1),false,true, ::Dynamic(new _hx_Closure_1()),null());
            				}
            				else {
            					HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_2) HXARGC(1)
            					void _hx_run( ::flixel::tweens::FlxTween twn){
            						HX_GC_STACKFRAME(&_hx_pos_fe772f19f43355ce_53_update)
HXLINE(  53)						::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE(  50)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(  50)					_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE(  51)					::flixel::tweens::FlxTween_obj::tween(this->warnText, ::Dynamic(::hx::Anon_obj::Create(1)
...
::hx::Val FlashingState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"warnText") ) { warnText=inValue.Cast<  ::flixel::FlxSprite >(); return inValue; }
	}
...
static ::hx::StorageInfo FlashingState_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::flixel::FlxSprite */ ,(int)offsetof(FlashingState_obj,warnText),HX_("warnText",13,f6,aa,7a)},
	{ ::hx::fsUnknown, 0, null()}
};
