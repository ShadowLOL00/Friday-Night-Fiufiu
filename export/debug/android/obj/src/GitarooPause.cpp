...
HX_LOCAL_STACK_FRAME(_hx_pos_d11df95f4b130531_84_changeThing,"GitarooPause","changeThing",0x5ce7c623,"GitarooPause.changeThing","GitarooPause.hx",84,0xccc591eb)
...
HXDLIN(  28)		 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/bfLol",a9,d6,8a,6b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
...
HXDLIN(  35)		 ::Dynamic _hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
...
HXDLIN(  42)		 ::Dynamic _hx_tmp4 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library3);
...
HXDLIN(  59)		if (!(::PlayerSettings_obj::player1->controls->_ui_leftP->check())) {
HXLINE(  59)			_hx_tmp = ::PlayerSettings_obj::player1->controls->_ui_rightP->check();
            		}
            		else {
...
HXLINE(  66)				::MusicBeatState_obj::switchState( ::PlayState_obj::__alloc( HX_CTX ,null(),null()));
            			}
            			else {
HXLINE(  70)				::PlayState_obj::usedPractice = false;
HXLINE(  71)				::PlayState_obj::changedDifficulty = false;
HXLINE(  72)				::PlayState_obj::seenCutscene = false;
HXLINE(  73)				::PlayState_obj::deathCounter = 0;
HXLINE(  74)				::PlayState_obj::cpuControlled = false;
...
HXDLIN(  76)				_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
            			}
            		}
...
void GitarooPause_obj::changeThing(){
            	HX_STACKFRAME(&_hx_pos_d11df95f4b130531_84_changeThing)
HXLINE(  85)		this->replaySelect = !(this->replaySelect);
HXLINE(  87)		if (this->replaySelect) {
HXLINE(  89)			this->cancelButton->animation->_curAnim->set_curFrame(0);
HXLINE(  90)			this->replayButton->animation->_curAnim->set_curFrame(1);
            		}
            		else {
HXLINE(  94)			this->cancelButton->animation->_curAnim->set_curFrame(1);
HXLINE(  95)			this->replayButton->animation->_curAnim->set_curFrame(0);
            		}
            	}
