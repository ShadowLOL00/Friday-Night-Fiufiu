...
HXDLIN( 239)				this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + ((HX_("pixelUI/",95,50,4f,7e) + blahblah) + HX_("ENDS",38,24,d7,2d))) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE( 240)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 241)				this->set_height((this->get_height() / ( (Float)(2) )));
HXLINE( 242)				::String library1 = null();
HXDLIN( 242)				 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + ((HX_("pixelUI/",95,50,4f,7e) + blahblah) + HX_("ENDS",38,24,d7,2d))) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN( 242)				int _hx_tmp1 = ::Math_obj::floor(this->get_width());
HXDLIN( 242)				this->loadGraphic(_hx_tmp,true,_hx_tmp1,::Math_obj::floor(this->get_height()),null(),null());
            			}
            			else {
HXLINE( 244)				::String library = null();
HXDLIN( 244)				this->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("pixelUI/",95,50,4f,7e) + blahblah)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE( 245)				this->set_width((this->get_width() / ( (Float)(4) )));
HXLINE( 246)				this->set_height((this->get_height() / ( (Float)(5) )));
HXLINE( 247)				::String library1 = null();
HXDLIN( 247)				 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("pixelUI/",95,50,4f,7e) + blahblah)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN( 247)				int _hx_tmp1 = ::Math_obj::floor(this->get_width());
HXDLIN( 247)				this->loadGraphic(_hx_tmp,true,_hx_tmp1,::Math_obj::floor(this->get_height()),null(),null());
            			}
...
HXDLIN( 253)			 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 253)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
