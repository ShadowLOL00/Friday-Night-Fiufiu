...
HX_LOCAL_STACK_FRAME(_hx_pos_d5932b697384537c_92_reloadAnimations,"DialogueCharacter","reloadAnimations",0xc9b79b65,"DialogueCharacter.reloadAnimations","DialogueBoxPsych.hx",92,0xf6ef1736)
HX_LOCAL_STACK_FRAME(_hx_pos_d5932b697384537c_103_playAnim,"DialogueCharacter","playAnim",0x25fc6ae2,"DialogueCharacter.playAnim","DialogueBoxPsych.hx",103,0xf6ef1736)
HX_LOCAL_STACK_FRAME(_hx_pos_d5932b697384537c_138_animationIsLoop,"DialogueCharacter","animationIsLoop",0x9ed1aa75,"DialogueCharacter.animationIsLoop","DialogueBoxPsych.hx",138,0xf6ef1736)
...
HXDLIN(  79)		 ::Dynamic _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  79)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
...
HXLINE(  86)		::String file = characterPath;
HXDLIN(  86)		if (::hx::IsNull( file )) {
HXLINE(  86)			file = HX_("",00,00,00,00);
            		}
HXDLIN(  86)		::String path = (HX_("assets/",4c,2a,dc,36) + file);
HXLINE(  87)		rawJson = ::openfl::utils::Assets_obj::getText(path);
HXLINE(  89)		this->jsonFile =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
            	}
...
void DialogueCharacter_obj::reloadAnimations(){
            	HX_STACKFRAME(&_hx_pos_d5932b697384537c_92_reloadAnimations)
HXLINE(  93)		this->dialogueAnimations->clear();
HXLINE(  94)		bool _hx_tmp;
HXDLIN(  94)		if (::hx::IsNotNull( this->jsonFile->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic) )) {
HXLINE(  94)			_hx_tmp = (( (::Array< ::Dynamic>)(this->jsonFile->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic)) )->length > 0);
            		}
            		else {
...
HXLINE(  95)			int _g = 0;
HXDLIN(  95)			::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(this->jsonFile->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic)) );
HXDLIN(  95)			while((_g < _g1->length)){
HXLINE(  95)				 ::Dynamic anim = _g1->__get(_g);
HXDLIN(  95)				_g = (_g + 1);
HXLINE(  96)				this->animation->addByPrefix(( (::String)(anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) ),( (::String)(anim->__Field(HX_("loop_name",46,3d,8f,96),::hx::paccDynamic)) ),24,this->isGhost,null(),null());
HXLINE(  97)				this->animation->addByPrefix(( (::String)((anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic) + ::DialogueCharacter_obj::IDLE_SUFFIX)) ),( (::String)(anim->__Field(HX_("idle_name",96,be,e2,c5),::hx::paccDynamic)) ),24,true,null(),null());
HXLINE(  98)				this->dialogueAnimations->set(( (::String)(anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) ),anim);
            			}
            		}
            	}
...
void DialogueCharacter_obj::playAnim(::String animName,::hx::Null< bool >  __o_playIdle){
            	...
            	HX_STACKFRAME(&_hx_pos_d5932b697384537c_103_playAnim)
HXLINE( 104)		::String leAnim = animName;
HXLINE( 105)		bool _hx_tmp;
HXDLIN( 105)		if (::hx::IsNotNull( animName )) {
HXLINE( 105)			_hx_tmp = !(this->dialogueAnimations->exists(animName));
            		}
            		else {
HXLINE( 105)			_hx_tmp = true;
            		}
HXDLIN( 105)		if (_hx_tmp) {
HXLINE( 106)			::Array< ::String > arrayAnims = ::Array_obj< ::String >::__new(0);
HXLINE( 107)			{
HXLINE( 107)				 ::Dynamic anim = this->dialogueAnimations->iterator();
HXDLIN( 107)				while(( (bool)(anim->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 107)					 ::Dynamic anim1 = anim->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXLINE( 108)					arrayAnims->push( ::Dynamic(anim1->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)));
            				}
            			}
HXLINE( 110)			if ((arrayAnims->length > 0)) {
HXLINE( 111)				leAnim = arrayAnims->__get(::flixel::FlxG_obj::random->_hx_int(0,(arrayAnims->length - 1),null()));
            			}
            		}
HXLINE( 115)		bool _hx_tmp1;
HXDLIN( 115)		if (this->dialogueAnimations->exists(leAnim)) {
HXLINE( 116)			bool _hx_tmp;
HXDLIN( 116)			if (::hx::IsNotNull( this->dialogueAnimations->get(leAnim)->__Field(HX_("loop_name",46,3d,8f,96),::hx::paccDynamic) )) {
HXLINE( 116)				_hx_tmp = (( (::String)(this->dialogueAnimations->get(leAnim)->__Field(HX_("loop_name",46,3d,8f,96),::hx::paccDynamic)) ).length < 1);
            			}
            			else {
HXLINE( 116)				_hx_tmp = true;
            			}
HXDLIN( 116)			if (!(_hx_tmp)) {
HXLINE( 118)				::String _hx_tmp = ( (::String)(this->dialogueAnimations->get(leAnim)->__Field(HX_("loop_name",46,3d,8f,96),::hx::paccDynamic)) );
HXLINE( 115)				_hx_tmp1 = ::hx::IsEq( _hx_tmp,this->dialogueAnimations->get(leAnim)->__Field(HX_("idle_name",96,be,e2,c5),::hx::paccDynamic) );
            			}
            			else {
...
HXLINE( 119)			playIdle = true;
            		}
HXLINE( 121)		::String _hx_tmp2;
HXDLIN( 121)		if (playIdle) {
HXLINE( 121)			_hx_tmp2 = (leAnim + ::DialogueCharacter_obj::IDLE_SUFFIX);
            		}
            		else {
HXLINE( 121)			_hx_tmp2 = leAnim;
            		}
HXDLIN( 121)		this->animation->play(_hx_tmp2,false,null(),null());
HXLINE( 123)		if (this->dialogueAnimations->exists(leAnim)) {
HXLINE( 124)			 ::Dynamic anim = this->dialogueAnimations->get(leAnim);
HXLINE( 125)			if (playIdle) {
HXLINE( 126)				this->offset->set( ::Dynamic(anim->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic))->__GetItem(1));
            			}
            			else {
HXLINE( 129)				this->offset->set( ::Dynamic(anim->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic))->__GetItem(1));
            			}
            		}
            		else {
HXLINE( 133)			this->offset->set(0,0);
            		}
            	}
...
bool DialogueCharacter_obj::animationIsLoop(){
            	HX_STACKFRAME(&_hx_pos_d5932b697384537c_138_animationIsLoop)
HXLINE( 139)		if (::hx::IsNull( this->animation->_curAnim )) {
HXLINE( 139)			return false;
            		}
HXLINE( 140)		return !(::StringTools_obj::endsWith(this->animation->_curAnim->name,::DialogueCharacter_obj::IDLE_SUFFIX));
            	}
