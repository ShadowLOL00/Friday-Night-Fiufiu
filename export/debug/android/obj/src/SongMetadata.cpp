...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_404_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",404,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_404_new)
HXLINE( 410)		this->folder = HX_("",00,00,00,00);
HXLINE( 409)		this->color = -7179779;
HXLINE( 408)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 407)		this->week = 0;
HXLINE( 406)		this->songName = HX_("",00,00,00,00);
HXLINE( 414)		this->songName = song;
HXLINE( 415)		this->week = week;
HXLINE( 416)		this->songCharacter = songCharacter;
HXLINE( 417)		this->color = color;
HXLINE( 418)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 419)		if (::hx::IsNull( this->folder )) {
HXLINE( 419)			this->folder = HX_("",00,00,00,00);
            		}
            	}
